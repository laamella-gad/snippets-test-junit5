...
public class SnippetFileFormat {
    ...
    final String separatorBetweenTestCases;
     ...
     * @param separatorBetweenTestCases    the separator that goes between the testcases in the file. TODO They come in the same order as the tGenerators. Don't forget to include \n if you want new lines.
     ...
     */
    public SnippetFileFormat(String descriptionStartString, String descriptionEndString, String separatorBetweenTestCases,String separatorAfterTestCase, String separatorBetweenExpectations, String expectationsEndString) {
        ...
        this.separatorBetweenTestCases = requireNonNull(separatorBetweenTestCases);
